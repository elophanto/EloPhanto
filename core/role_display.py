...
async def build_role_roster_context(
    *,
    ...
    return (
        ...
        "Pick the hat by the WORK, not your default seat: prospect research / "
        "posts / content → Marketing; leads / outreach / follow-up → Sales; "
        "infra / scheduling / hygiene → Operations; inbound / issues → Support; "
        "strategy / capital / final calls → the top seat. If a reply genuinely "
        "spans functions, label each part with its own hat.\n"
