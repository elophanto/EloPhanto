...
class ToolRegistry:
    ...
    def load_builtin_tools(self, config: Any) -> None:
        ...
        # Fiat rail (Stripe) — ABE finance rail Slices 2-3 (Receive + Spend).
        ...
        self.register(FiatReconcileTool())
        self.register(FiatIssueCardTool())
        ...
        # Pump.fun — livestream (video / voice publish) + chat + say (TTS) + caption (overlay)
        from tools.pumpfun.caption_tool import PumpCaptionTool
        from tools.pumpfun.chat_tool import PumpChatTool
        from tools.pumpfun.livestream_tool import PumpLivestreamTool
        from tools.pumpfun.voice_tool import PumpSayTool
        ...
        from tools.agent_identity.p2p_disconnect_tool import (
            AgentP2PDisconnectTool,
        )
        ...
        self.register(AgentP2PConnectTool())
