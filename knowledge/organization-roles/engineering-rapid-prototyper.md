# Organization Role: Rapid Prototyper
> Source: msitarzewski/agency-agents (Apache 2.0)
> Use with: organization_spawn role="rapid-prototyper"
...
export function useABTest(testName: string, variants: string[]) {
  ...
  useEffect(() => {
    ...
    trackEvent('ab_test_assignment', { test_name: testName, variant: assignedVariant, user_id: userId });
  }, [testName, variants]);
  return variant;
}
```
