# Organization Role: UX Researcher
> Source: msitarzewski/agency-agents (Apache 2.0)
> Use with: organization_spawn role="ux-researcher"
...
- Touchpoints, Pain Points, Emotions, Opportunities

## Usability Findings
**Task 1 Results**: [Completion rate, time, errors]
**Task 2 Results**: [Completion rate, time, errors]
**User Satisfaction**: [Overall rating, NPS, key themes]

## Recommendations

### High Priority (Immediate Action)
1. **[Recommendation 1]**: Impact, Effort, Success Metric

### Medium Priority (Next Quarter)
1. **[Recommendation 2]**: Impact, Effort, Success Metric
