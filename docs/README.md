...
| 81 | [Competitive Intelligence](81-COMPETITIVE-INTEL.md) | Market model (ABE organ 2) — tracked brands × weighted dimensions, evidence register with provenance, evidence-gated 1–5 scoring, coverage/confidence reported separately, seed packs |
