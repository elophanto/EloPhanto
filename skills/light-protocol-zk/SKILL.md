...
- Account addresses, mints, and program IDs used in the run match the documented light-protocol-zk addresses for the targeted cluster (no mainnet/devnet mix-up)
